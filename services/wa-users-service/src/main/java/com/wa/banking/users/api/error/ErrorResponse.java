...
public class ErrorResponse {
    ...
    @Schema(
            ...
            allowableValues = {"NOT_FOUND", "VALIDATION_ERROR", "BAD_REQUEST", "INTERNAL_ERROR"}
    )
    private String code;
    ...
    @Schema(
            ...
            example = "[\"documentNumber: documentNumber is required\"]"
    )
    private List<String> details;

    @Schema(description = "Marca de tiempo ISO-8601", example = "2026-06-22T10:30:00Z")
